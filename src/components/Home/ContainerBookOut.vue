    ...
    <div class="container-book-out" :style="`right: ${props.item}px;`">
          <div class="container-book">
            ...
            <div class="card-container-home">
             <span class="linkBooks" @click="toRoute(props.data)" ><BookDetail :categories="props.data.categoria" :url="props.data.capa.url ? props.data.capa.url : props.data.capa.file" :genere="props.data.generos" :is_avaible="props.data.disponivel" is_list="list"/>
             </span>
            </div>
